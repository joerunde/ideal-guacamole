...
from Metropolis.mlfkt_transition_difficulty_model import MLFKTTransitionDifficultyModel
...
for it in range(iterz):
    ...
    paramfname = 'dump/PARAMS_' + fname + "_transdiff_" + str(total_states) + "states_" + str(num_iterations) +"iter" + '.json'
