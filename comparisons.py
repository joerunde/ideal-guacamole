...
for sk in skills:
    #BKT first
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_bkt_2states_500iter.json","r")))
        table[sk]['BKT'] = val
    except:
        pass
    ...
    #BKT-4
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_bkt_4states_500iter.json","r")))
        table[sk]['BKT-4'] = val
    except:
        pass
    ...
    #LFKT
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_2states_500iter.json","r")))
        table[sk]['LFKT'] = val
    except:
        pass
    ...
    #LFKT-4
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_4states_500iter.json","r")))
        table[sk]['LFKT-4'] = val
    except:
        pass
    ...
    #LFKT (L1)
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_L1_2states_500iter.json","r")))
    ...
    #LFKT-skills (L1)
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_L1_2states_500iter_skillmodel.json","r")))
    ...
    #LFKT-transition
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_trans_2states_500iter.json","r")))
        table[sk]['LFKT-transition'] = val
    except:
        pass

    #LFKT-transition (L1)
    try:
        val = np.mean(json.load(open("mar29_exps/RMSE_" + sk + "_L1_trans_2states_500iter.json","r")))
