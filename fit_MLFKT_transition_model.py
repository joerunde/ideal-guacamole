...
print "usage: python fit_MLFKT_transition_model.py burnin iterations k(for 1/k test split) bkt(y/n) skills num_intermediate_states iterations L1/L2 [transition first?]"
