...
from Metropolis.mlfkt_usefulness_penalty_fake_model import MLFKTSUPModel
...
for it in range(iterz):
    ...
    rmsefname = 'dump/RMSE_fake_pen_useful_' + fname + "_" + str(total_states) + "states_" + str(num_iterations) +"iter" + '.json'
    if os.path.exists(rmsefname):
        rmsel = json.load(open(rmsefname,"r"))
    else:
        rmsel = []
    ...
    paramfname = 'dump/PARAMS_fake_pen_useful_' + fname + "_" + str(total_states) + "states_" + str(num_iterations) +"iter" + '.json'
