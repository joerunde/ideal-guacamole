...
print "usage: python fit_MLFKT_skill_model.py burnin iterations k(for 1/k test split) bkt(y/n) skills num_intermediate_states iterations L1/L2"
...
for it in range(iterz):
    ...
    P = np.loadtxt(open("dump/skills_" + fname + ".csv","rb"),delimiter=",")
    ...
    f = open(folder + "/RMSE" + str(num_iterations) + '_skillmodel_iterations', "w+")
    ...
    rmsefname = 'dump/RMSE_' + fname + "_" + str(total_states) + "states_" + str(num_iterations) +"iter_skillmodel" + '.json'
    ...
    paramfname = 'dump/PARAMS_' + fname + "_" + str(total_states) + "states_" + str(num_iterations) +"iter_skillmodel" + '.json'
